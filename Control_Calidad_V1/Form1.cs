...
CALC:
@SOLVE(CALIDAD);
@DIVERT('C:\\Users\\RENZO\\Desktop\\PROYECTOS\\ProjectLingo-main-VF\\Control_Calidad_V1\\SOL.TXT');
...
";
                ...
                string rutaModelo = @"C:\Users\RENZO\Desktop\PROYECTOS\ProjectLingo-main-VF\Control_Calidad_V1\mod_temp.lng";  // Ruta del archivo LINGO
                File.WriteAllText(rutaModelo, modelo);
                string archivoSalida = @"C:\Users\RENZO\Desktop\PROYECTOS\ProjectLingo-main-VF\Control_Calidad_V1\SOL.TXT"; // Archivo de salida esperado
